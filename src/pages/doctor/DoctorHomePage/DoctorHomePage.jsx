              ...
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    name="specialization"
                    id="specialization"
                    value={physioData.specialization}
                    // onChange={(e) =>
                    //   setNewUser({
                    //     ...newUser,
                    ...
                    required
                    disabled
                    className="text-[var(--text-color)] disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                  ...
                  <div>
                    ...
                    <svg
                      ...
                      name="fee"
                      id="fee"
                      value={physioData.consultation_fee}
                      ...
                      //   })
                      // }
                      className="w-[80%] disabled:cursor-not-allowed disabled:opacity-50"
                      required
                      disabled
                    />
