...
const Appointments = () => {
  ...
  const startSession = async (sessionId) => {
    ...
    try {
      const response = await fetch(
        `https://unjuicy-schizogenous-gibson.ngrok-free.dev/api/provider/nurse/schedules/${sessionId}/start-session`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  const endSession = async (sessionId, patientId) => {
    ...
    try {
      const response = await fetch(
        `https://unjuicy-schizogenous-gibson.ngrok-free.dev/api/provider/nurse/schedules/${sessionId}/end-session`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
