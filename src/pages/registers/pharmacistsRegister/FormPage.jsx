...
import FileInput from "src/pages/registers/pharmacistsRegister/FormPage ";
import "./FormPage.css";
...
setError(null);
  ...
  try {
    const response = await fetch("https://unjuicy-schizogenous-gibson.ngrok-free.dev/api/auth/register", {
      method: "POST",
      headers: {
        ...
        <div className="form-header">
          <div className="back-arrow" onClick={handleBack}>
            <svg width="34" height="34" viewBox="0 0 24 24" fill="#0d3b66">
              <path d="M15 18l-6-6 6-6" stroke="#0d3b66" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
          </div>
...
<div className="input-field" style={{ position: "relative" }}>
  <label htmlFor="password" aria-hidden>
    <svg width="34" height="34" viewBox="0 0 30 31" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<input
  ...
  placeholder="From:..."
  onChange={(e) => setNewUser({ ...newUser, fromDate: e.target.value })}
/>
            </div>
  ...
  placeholder="To:..."
  onChange={(e) => setNewUser({ ...newUser, toDate: e.target.value })}
/>
            </div>
          </div>
...
/>
            ...
            <div className="input-field">
              <label htmlFor="mapLocation">
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="34" height="34" fill="#39CCCC"  version="1.1" id="Capa_1" viewBox="0 0 296.999 296.999" xml:space="preserve">
<g>
...
<input
  ...
  name="mapLocation"
  id="mapLocation"
  value={newUser.mapLocation}
  placeholder="Location in Map"
  onChange={(e) => setNewUser({ ...newUser, mapLocation: e.target.value })}
/>
            </div>
          </div>

          {/* Row 6: Upload Certificate */}
          <FileInput placeholder="Upload Certificate File" icon={faCertificate} /> {/* أيقونة شهادة */}

          {/* Row 7: Pharmacy Name + CR Number */}
          <div className="row">
            <div className="input-field">
              <label htmlFor="pharmacyName">
  <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="34" height="34"  fill="#39CCCC"viewBox="0 0 256 201" enable-background="new 0 0 256 201" xml:space="preserve">
...
/>
            ...
            <div className="input-field">
              <label htmlFor="crNumber">
                 <svg xmlns="http://www.w3.org/2000/svg"  width="34" height="34"  fill="#39CCCC" viewBox="0 0 48 48">
...
<input
  ...
  onChange={(e) => setNewUser({ ...newUser, crNumber: e.target.value })}
/>
            </div>
          </div>
