...
const HeroSection = () => {
  return (
    <div className="flex items-center justify-between bg-[#f7f7f7ed] md:px-[3rem] px-[1.5rem] md:py-[4rem] py-[2rem] w-full">
      <div className={`hero-content md:w-[50%]`}>
        <div className="flex flex-col items-start justify-center md:gap-[1.5rem] gap-[1rem]">
          ...
          <Link to='/register' className="text-[var(--dark-blue)] border-[2px] border-[var(--dark-blue)] hover:border-[var(--card-border)] hover:bg-[var(--card-border)] duration-400 rounded-[25px] px-[0.8rem] py-[0.5rem] font-medium">
            Sign up
          </Link>
        </div>
      </div>
      <div className="overflow-hidden md:w-[40%] md:block hidden">
