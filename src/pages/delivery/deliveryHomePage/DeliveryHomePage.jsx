...
import { faEye, faEyeSlash ,faCar, faHashtag,} from "@fortawesome/free-solid-svg-icons";
              ...
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <div className="flex items-center w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#39CCCC] focus:border-transparent">
                    <FontAwesomeIcon icon={faCar} className="text-[var(--cyan)] text-[25px]"/>
                    <input
                      type="text"
                      value="Toyota"
                      onChange={(e) =>
                  ...
                  <div>
                    ...
                    <div className="flex items-center w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#39CCCC] focus:border-transparent">
                    <FontAwesomeIcon icon={faHashtag} className="text-[var(--cyan)] text-[25px]"/>
                    <input
                      type="number"
                      value="123123"
                      // onChange={(e) =>
